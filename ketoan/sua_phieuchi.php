...
<body>
     ...
     <div class="d-flex" id="wrapper">
        ...
        <!-- Thông tin chung -->
        <form action="index.php?act=sua_phieuchi" method="POST">
        <input type="hidden" name="pc_id" value="<?php echo htmlspecialchars($thucu['PC_ID']); ?>"> <!-- Lưu ID phiếu thu -->
    <!-- <div class="section-title">Thông tin chung</div> -->
    <!-- <div class="row mt-3">
        <div class="col-md-12">
            <label>Đối tượng</label>
            <div class="dropdown w-100">
                <input type="text" class="form-control dropdown-toggle custom-dropdown-input" id="doituongInput" name="doituong" data-bs-toggle="dropdown" placeholder="Chọn mã đối tượng" autocomplete="off" value="<?php echo htmlspecialchars($thucu['NCC_ID']); ?>" required>
    ...
    <div class="row mt-3">
        <div class="col-md-4">
            ...
            <input type="date" class="form-control" name="ngay_hachtoan" value="<?php echo htmlspecialchars($thucu['PC_NGAYHOACHTOAN']); ?>" required>
        </div>
        <div class="col-md-4">
            <label>Ngày chứng từ</label>
            <input type="date" class="form-control" name="ngay_chungtu" value="<?php echo htmlspecialchars($thucu['PC_NGAYCHUNGTU']); ?>" required>
        </div>
        <div class="col-md-4">
            <label>Mã hóa đơn</label>
            <div class="dropdown w-100">
                <input type="text" class="form-control dropdown-toggle custom-dropdown-input" id="hoadonInput" name="hoadon" data-bs-toggle="dropdown" placeholder="Chọn mã hóa đơn" autocomplete="off" value="<?php echo htmlspecialchars($thucu['HDM_ID']); ?>" readonly required>
                <ul class="dropdown-menu w-100" id="doituongList">
    ...
    <table class="table table-bordered mt-3">
        ...
        <tbody>
            <tr>
                <td>
                    <div class="dropdown w-100">
                        <input type="text" class="form-control dropdown-toggle custom-input" id="diengiaiInput" name="diengiai" data-bs-toggle="dropdown" placeholder="Chọn diễn giải" autocomplete="off" value="<?php echo htmlspecialchars($thucu['TKKT_ID']); ?>" required>
                ...
                <td><input type="text" class="form-control" id="tkNoInput" name="tk_no" placeholder="TK Nợ" value="<?php echo htmlspecialchars($thucu['TKKT_NO']); ?>" required></td>
                <td><input type="text" class="form-control" id="tkCoInput" name="tk_co" placeholder="TK Có" value="<?php echo htmlspecialchars($thucu['TKKT_CO']); ?>" required></td>
                <td><input type="number" class="form-control" name="so_tien" placeholder="Nhập số tiền" min=0 value="<?php echo htmlspecialchars($thucu['PC_SOTIEN']); ?>" required></td>
    ...
    <div class="dropdown w-100">
        <input type="text" class="form-control dropdown-toggle custom-input" 
            ...
            autocomplete="off" 
            value="<?php echo htmlspecialchars($thucu['NCC_ID']); ?>"
            required>
        <ul class="dropdown-menu w-100" id="doituongList">
            <?php foreach ($ncc as $cus): ?>
                <li>
...
<td>
    <input type="text" class="form-control" id="tenDoiTuong" name="ten_doi_tuong" placeholder="Chọn đối tượng" value="<?php echo htmlspecialchars($thucu['NCC_TEN']); ?>" readonly>
</td> -->
    ...
    <div class="text-center mt-4">
        <input type="submit" class="btn-submit" name="suachi" value="Lưu phiếu thu">
    </div>
</form>
