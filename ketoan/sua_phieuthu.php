...
<body>
     ...
     <div class="d-flex" id="wrapper">
        ...
        <div id="page-content" class="w-100">
            ...
            <div class="container mt-4">
                <h3>Sửa phiếu thu</h3>
               <!-- Thông tin chung -->
        <form action="index.php?act=edit-receipt" method="POST">
        <input type="hidden" name="pt_id" value="<?php echo htmlspecialchars($thucu['PT_ID']); ?>"> <!-- Lưu ID phiếu thu -->
    <!-- <div class="section-title">Thông tin chung</div>
    <div class="row mt-3">
        <div class="col-md-12">
            <label>Đối tượng</label>
            <div class="dropdown w-100">
                <input type="text" class="form-control dropdown-toggle custom-dropdown-input custom-input" id="doituongInput" name="doituong" data-bs-toggle="dropdown" placeholder="Chọn mã đối tượng" autocomplete="off" required value="<?php echo htmlspecialchars($thucu['KH_ID']); ?>">
                <ul class="dropdown-menu w-100" id="doituongList">
                    <?php foreach ($kh as $cus): ?>
                        <li>
                            <a class="dropdown-item" href="#" onclick="event.preventDefault(); selectDoiTuong('<?php echo htmlspecialchars($cus['KH_ID']); ?>')">
                                <?php echo htmlspecialchars($cus['KH_ID']); ?> - <?php echo htmlspecialchars($cus['KH_HOTEN']); ?>
                            </a>
                        </li>
                    <?php endforeach; ?>
                </ul>
    ...
    <div class="row mt-3">
        <div class="col-md-4">
            ...
            <input type="date" class="form-control" name="ngay_hachtoan"  value="<?php echo htmlspecialchars($thucu['PT_NGAYHOACHTOAN']); ?>" required>
        </div>
        <div class="col-md-4">
            <label>Ngày chứng từ</label>
            <input type="date" class="form-control" name="ngay_chungtu" value="<?php echo htmlspecialchars($thucu['PT_NGAYCHUNGTU']); ?>" required>
        </div>
        <div class="col-md-4">
            <label>Mã hóa đơn</label>
            <div class="dropdown w-100">
                <input type="text" class="form-control dropdown-toggle custom-dropdown-input" id="hoadonInput" name="hoadon" data-bs-toggle="dropdown" placeholder="Chọn mã hóa đơn" autocomplete="off" value="<?php echo htmlspecialchars($thucu['HDB_ID']); ?>" readonly required>
                <ul class="dropdown-menu w-100" id="doituongList">
                    <?php foreach ($hdb as $cus): ?>
                        <li>
                            <a class="dropdown-item" href="#" onclick="event.preventDefault(); selectHoaDon('<?php echo htmlspecialchars($cus['HDB_ID']); ?>')">
                                <?php echo htmlspecialchars($cus['HDB_ID']); ?>
                            </a>
                        </li>
                    <?php endforeach; ?>
                </ul>
    ...
    <table class="table table-bordered mt-3">
        ...
        <tbody>
            <tr>
                <td>
                    <div class="dropdown w-100">
                        <input type="text" class="form-control dropdown-toggle custom-input" id="diengiaiInput" name="diengiai" data-bs-toggle="dropdown" placeholder="Chọn diễn giải" autocomplete="off" value="<?php echo htmlspecialchars($thucu['TKKT_DIENGIAI']); ?>" readonly required>
                        <input type="hidden" id="diengiaiIdInput" name="diengiai_id" value="<?php echo htmlspecialchars($thucu['TKKT_ID']); ?>"> <!-- Trường ẩn lưu ID -->
                        <ul class="dropdown-menu w-100" id="diengiaiList">
                            <?php foreach ($kq as $dg): ?>
                                <li>
                                    <a class="dropdown-item" href="#" onclick="event.preventDefault(); selectDienGiai(
                                        '<?php echo htmlspecialchars($dg['TKKT_ID']); ?>',  // ID của diễn giải
                ...
                <td><input type="text" class="form-control" id="tkNoInput" name="tk_no" placeholder="TK Nợ" value="<?php echo htmlspecialchars($thucu['TKKT_NO']); ?>" readonly required></td>
                <td><input type="text" class="form-control" id="tkCoInput" name="tk_co" placeholder="TK Có" value="<?php echo htmlspecialchars($thucu['TKKT_CO']); ?>" readonly required></td>
                <td><input type="number" class="form-control" name="so_tien" placeholder="Nhập số tiền" min=0 value="<?php echo htmlspecialchars($thucu['PT_SOTIEN']); ?>" required></td>
    ...
    <div class="dropdown w-100">
        <input type="text" class="form-control dropdown-toggle custom-input" 
            ...
            autocomplete="off" 
            value="<?php echo htmlspecialchars($thucu['KH_ID']); ?>"
            required>
        <ul class="dropdown-menu w-100" id="doituongList">
            <?php foreach ($kh as $cus): ?>
                <li>
                    <a class="dropdown-item" href="#" onclick="event.preventDefault(); selectDoiTuong2(
                        '<?php echo htmlspecialchars($cus['KH_ID']); ?>',  
                        '<?php echo htmlspecialchars($cus['KH_HOTEN']); ?>'
                    )">
                        <?php echo htmlspecialchars($cus['KH_ID']); ?> - <?php echo htmlspecialchars($cus['KH_HOTEN']); ?>
                    </a>
                </li>
...
<!-- <td>
    <input type="text" class="form-control" id="tenDoiTuong" name="ten_doi_tuong" placeholder="Chọn đối tượng" value="<?php echo htmlspecialchars($thucu['KH_HOTEN']); ?>" readonly>
</td> -->
    ...
    <div class="text-center mt-4">
        <input type="submit" class="btn-submit" name="luulai" value="Lưu phiếu thu">
    </div>
</form>
