...
<div class="receipt-header-container">
    ...
    <div class="info-banhanh">
        ...
        <div class="receipt-info">
            <p><strong>Mã phiếu thu:</strong> <?php echo $phieu['PT_ID']; ?></p>
            <p><strong>Ngày lập:</strong> <?php echo $phieu['PT_NGAYHOACHTOAN']; ?></p>
        </div>
    </div>
</div>
<div class="receipt-header">Phiếu Thu</div>
<div class="receipt-content">
    <p><strong>Mã phiếu thu:</strong> <?php echo $phieu['PT_ID']; ?></p>
    <p><strong>Mã hóa đơn:</strong> <?php echo $phieu['HDB_ID']; ?></p>
    <p><strong>Khách hàng:</strong> <?php echo $phieu['KH_HOTEN']; ?></p>
    <p><strong>Số điện thoại:</strong> <?php echo $phieu['KH_SDT']; ?></p>
    <p><strong>Địa chỉ:</strong> <?php echo $phieu['KH_DIACHI']; ?></p>
    <p class="amount"><strong>Số tiền:</strong> <?php echo number_format($phieu['PT_SOTIEN'], 0, ',', '.'); ?> VND</p>
</div>
...
<body>
    <div id="content-to-print">
        ...
        <p><strong>Số điện thoại:</strong> <?php echo $phieu['KH_SDT']; ?></p>
        <p><strong>Địa chỉ:</strong> <?php echo $phieu['KH_DIACHI']; ?></p>
        <p><strong>Số tiền:</strong> <?php echo number_format($phieu['PT_SOTIEN'], 0, ',', '.'); ?> VND</p>
        <p><strong>Ngày lập:</strong> <?php echo $phieu['PT_NGAYHOACHTOAN']; ?></p>
    </div>

    <button id="download-pdf">Xuất PDF</button>

    <script>
        document.getElementById('download-pdf').addEventListener('click', function() {
            const { jsPDF } = window.jspdf; // Lấy jsPDF từ thư viện
            html2canvas(document.getElementById('content-to-print')).then(function(canvas) {
                const imgData = canvas.toDataURL('image/png');
                const pdf = new jsPDF('p', 'mm', 'a4');
