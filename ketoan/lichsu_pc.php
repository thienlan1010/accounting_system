        ...
        <div id="page-content" class="w-100">
            ...
            <div class="container mt-4">
                ...
                <table class="category-table">
                    ...
                    <?php //var_dump($dm);
                                if(isset($lspc) && (count($lspc) > 0)){//>1 tức có dl 
                                    // echo var_dump($lspt);
                                    $i=1;
                                    foreach ($lspc as $ls) {
                                        echo '<tr>
                                                ...
                                                <td>'.$ls['LSC_MANV'].'</td>
                                                <td>'.$ls['NV_HOTEN'].'</td> 
                                                <td>'.$ls['LSC_THOIGIAN'].'</td>                                             
                                                <td>'.$ls['LSC_TRUOC_SUA'].'</td>
                                                <td>'.$ls['LSC_SAU_SUA'].'</td>
                                                <td>'.$ls['LSC_HTOAN_TRUOC'].'</td>
                                                <td>'.$ls['LSC_HTOAN'].'</td>
                                                <td>'.$ls['LSC_CTU_TRUOC'].'</td>                                                                                                                         
                                                <td>'.$ls['LSC_CTU'].'</td>                                                                                                                         
                                                <td>'.$ls['TKKT_TRUOC'].'</td>                                                                                                                         
                                                <td>'.$ls['TKKT_ID'].'</td>                                                                                                                         
                                            </tr>';
