        ...
        <div id="page-content" class="w-100">
            ...
            <div class="container mt-4">
                ...
                <table class="category-table">
                    ...
                    <?php //var_dump($dm);
                                if(isset($ctpt) && (count($ctpt) > 0)){//>1 tức có dl 
                                    $i=1;
                                    foreach ($ctpt as $ct) {
                                        echo '<tr>
                                                <td>'.$i.'</td>
                                                ...
                                                <td>'.$ct['NV_ID'].'</td>                                      
                                                <td>'.$ct['NV_HOTEN'].'</td>                                      
                                                <td><a class="btn-edit" href="index.php?act=lichsu-pt&id='.$ct['PT_ID'].'">Lịch sử</a>
...
<!-- <a class="btn-del" href="#" onclick="xoa('.$ct['PT_ID'].')">Xóa</a> -->
</body>
</html>