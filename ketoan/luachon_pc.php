     ...
     <div class="d-flex" id="wrapper">
        ...
        <div id="page-content" class="w-100">
            ...
            <div class="container mt-4">
                ...
                <div class="option">
                    <a class="btn-edit" href="index.php?act=chitiet-pc&id=<?php echo $kqluachon?>'">Xem chi tiết</a>
                    <a class="btn-sua" href="index.php?act=suaphieuchi&id=<?php echo $kqluachon?>">Sửa phiếu chi</a>
                    <a class="btn-del" href="#" onclick="xoa('<?php echo $kqluachon?>')">Xóa phiếu chi</a>
                    <a class="btn-in" href="index.php?act=in-phieuchi&id=<?php echo $kqluachon?>">In phiếu chi</a>  
                </div>
            </div>
        </div>
    </div>
    <script>
        function xoa(id) {
            if (confirm("Bạn có chắc muốn xóa phiếu thu này không?")) {
                window.location.href = "index.php?act=xoa_pc&id=" + id;
            }
        }
</script>
</body>
