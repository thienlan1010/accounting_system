...
<div class="d-flex" id="wrapper">
        ...
        <div id="page-content" class="w-100">
            ...
            <div class="nut-them">
                <a href="index.php?act=phieuchi">
                    <button type="button"><i class="fa-solid fa-plus"></i> Thêm phiếu chi</button>
                </a>
            </div>
    ...
    <!-- DANH SÁCH PHIẾU THU -->
        <div class="">
                ...
                <table class="category-table">
                    ...
                    <?php //var_dump($dm);
                                if(isset($dspc) && (count($dspc) > 0)){//>1 tức có dl 
                                    $i=1;
                                    foreach ($dspc as $ds) {
                                        echo '<tr>
                                                <td>'.$i.'</td>
                                                <td>'.$ds['PC_ID'].'</td>
                                                <td>'.$ds['HDM_ID'].'</td>
                                                <td>'.$ds['PC_NGAYHOACHTOAN'].'</td>
                                                <td>'.$ds['TKKT_DIENGIAI'].'</td>                                             
                                                <td>'.$ds['NCC_ID'].'</td>
                                                <td>'.$ds['NCC_TEN'].'</td>
                                                <td>'.$ds['PC_SOTIEN'].'</td>
                                                <td><a class="chon" href="index.php?act=chon_pc&id='.$ds['PC_ID'].'">Chọn</a></td>
                                                </td>
                                            </tr>';
                                            $i++;
                                    }
