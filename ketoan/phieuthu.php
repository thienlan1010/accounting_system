...
<body>
     ...
     <div class="d-flex" id="wrapper">
        ...
        <h2 class="text-center">Phiếu Thu</h2>
        
        <!-- Thông tin chung -->
        <form action="index.php?act=xuly-phieuthu" method="POST">
...
<!-- <td>
    ...
    <div class="text-center mt-4">
        <input type="submit" class="btn-submit" name="savethu" value="Lưu phiếu thu">
    </div>
</form>
